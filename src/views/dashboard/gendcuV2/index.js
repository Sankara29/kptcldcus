    ...
    const fetchData = async () => {
        try {
            ...
            const tmResponse = await fetch('https://api.ms-tech.in/v17/get-multiple-hashes', {
                ...
                body: JSON.stringify({ keys: keys, fields: ["tm", "REMARK","cv"] })
            });
            ...
            for (const item of tmData.data || []) {
                ...
                tmMap[nodeId + '_cv'] = item.data.cv || null;
            }
            ...
            nodes = nodes.map(node => ({
                ...
                cv: tmMap[node.node_id + '_cv'] || null,
            }));
...
`.trim();
    ...
    const submitRemark = async () => {
        ...
        await fetch('https://api.ms-tech.in/v17/addRemark', {
            method: 'POST',
            headers: {
                                ...
                                <AccordionHeader targetId="today-no-data">
                                    ...
                                    <FileText
                                        ...
                                        onClick={(e) => {
                                            ...
                                            exportToExcel(filtered, `today_no_data_${date}_004`);
                                        }}
                                    />
                                ...
                                <AccordionHeader targetId="today-partial">
                                    ...
                                    <FileText
                                        ...
                                        onClick={(e) => {
                                            ...
                                            exportToExcel(filtered, `today_partial_data_${date}_004`);
                                        }}
                                    />
                        ...
                        <AccordionHeader targetId="all-nodes">All Nodes Commucation Details
                            ...
                            <FileText
                                ...
                                onClick={(e) => {
                                    ...
                                    exportToExcel(allMeters, `all_nodes_${date}_004`);
                                }}
                            />
